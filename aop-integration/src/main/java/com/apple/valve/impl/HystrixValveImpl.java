...
public class HystrixValveImpl extends HystrixCommand<Object> implements IValveService {
    ...
    private DoIntegration doHystrix;
    ...
    @Override
    public Object access(ProceedingJoinPoint jp, Method method, DoIntegration doHystrix, Object[] args) {
        this.jp = jp;
        this.method = method;
    ...
    protected Object getFallback() {
        return ReflectUtils.returnObject(doHystrix,method);
    }
